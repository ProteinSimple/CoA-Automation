...
class ActionTest(unittest.TestCase):
    ...
    def test_check_action(self):
        ...
        for user, passkey, exp in cases:
            ...
            self.assertEqual(out.getvalue().strip()[0], exp) # Only check if fail or success !
            out.seek(0)
            out.truncate(0)
    ...
    def test_config_add_action(self):
        ...
        cases = [
            ...
            (["newPath", "newPath2", "newPath"], ["newPath", "newPath3", "newPath3"]),
            ([], [])
        ]
    ...
    def test_coa_action(self):
        ...
        for csv in csv_files:
            ...
            for val in values['LotNumber'].values:
                self.assertNotIn(int(val), seen_ids) # No Duplicate values in mapping
